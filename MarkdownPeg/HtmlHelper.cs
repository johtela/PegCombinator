namespace MarkdownPeg
{
	...
	public static class HtmlHelper
    {
		...
		public static string BasicEncode (char ch)
		{
			switch (ch)
			{
				case '&': return "&amp;";
		...
		public static string ExtendedEncode (char ch)
		{
			switch (ch)
			{
				case '[': return "%5B";
				case ']': return "%5D";
				default: return BasicEncode (ch);
			}
		}

		public static string HtmlEncode (string str, Func<char, string> encode)
		{
			if (str == null)
				return null;
			var res = new StringBuilder ();
			for (int i = 0; i < str.Length; i++)
				res.Append (encode (str[i]));
			return res.ToString ();
		}

		public static string HtmlEncode (string str) =>
			HtmlEncode (str, BasicEncode);
		...
		public static bool ValidTag (string tagName) =>
			TagSet.Contains (tagName.ToLower ());
